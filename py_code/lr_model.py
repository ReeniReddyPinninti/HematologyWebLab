...
from sklearn.linear_model import LogisticRegression # for implementing Support Vector Machine (SVM) algorithm
...
def predict_result_lr(gender, hemoglobin, mch, mchc, mcv ):
