...
from sklearn.neighbors import KNeighborsClassifier # for implementing Support Vector Machine (SVM) algorithm
...
def predict_opt_result_knn(gender, hemoglobin, mcv ):
...
def predict_result_knn(gender, hemoglobin, mch, mchc, mcv ):
