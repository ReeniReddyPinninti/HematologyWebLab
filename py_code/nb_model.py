...
from sklearn.naive_bayes import GaussianNB # for implementing Support Vector Machine (SVM) algorithm
...
def predict_opt_result_nb(gender, hemoglobin, mcv ):
...
def predict_result_nb(gender, hemoglobin, mch, mchc, mcv ):
